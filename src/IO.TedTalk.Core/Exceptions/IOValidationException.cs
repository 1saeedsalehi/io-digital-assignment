...
public class IOValidationException : IOException
{
    ...
    public IOValidationException(string message, IList<ValidationResult> validationErrors) : base(message)
    {
    ...
    /// </summary>
    /// <param name="message">The error message</param>
    /// <param name="innerException">The underlying exception which caused this instance of IOValidationException</param>
    public IOValidationException(string message, Exception innerException = null) : base(message, innerException)
    {
        ErrorCode = ExceptionCode;
        Severity = LogSeverity.Warn;
    }
